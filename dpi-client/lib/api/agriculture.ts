...
export const agricultureApi = {
  ...
  getSchemes: async (
    ...
    const response = await apiClient.get('/services/agriculture/schemes', {
      params: filters,
    });
  ...
  applyForScheme: async (
    ...
    const response = await apiClient.post(
      `/services/agriculture/schemes/${schemeId}/apply`,
      data,
    );
    return response.data.data;
  },
  ...
  ): Promise<PaginatedResponse<SchemeApplication>> => {
    const response = await apiClient.get(
      '/services/agriculture/schemes/me/applications',
      { params: filters },
    );
    return response.data;
  },
  ...
  getApplicationStatus: async (id: string): Promise<SchemeApplication> => {
    const response = await apiClient.get(
      `/services/agriculture/schemes/applications/${id}`,
    );
    return response.data.data;
  },
  ...
  getAdvisories: async (
    ...
    const response = await apiClient.get('/services/agriculture/advisories', {
      params: filters,
    });
    return response.data;
  },
  ...
  getMarketPrices: async (
    ...
    const response = await apiClient.get(
      '/services/agriculture/market-prices',
      { params: filters },
    );
    return response.data;
  },
  ...
  getCommodities: async (): Promise<string[]> => {
    const response = await apiClient.get(
      '/services/agriculture/market-prices/commodities',
    );
    return response.data.data;
  },
  ...
  getMandis: async (state?: string): Promise<string[]> => {
    const response = await apiClient.get(
      '/services/agriculture/market-prices/mandis',
      { params: { state } },
    );
    return response.data.data;
  },
